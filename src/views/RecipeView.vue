...
import { recipe_book, recipe_categories, recipe_images } from "./../lib/cv"; // Ensure correct import order
...
.ingredients-list {
  ...
  flex-shrink: 1;
  margin-left: 24px;
  /* Add these lines to make the ingredients list scroll independently */
...
@media (max-width: 768px) {
  ...
  .ingredients-list {
    ...
    overflow-y: visible; /* Allow list to grow naturally on mobile */
  }
